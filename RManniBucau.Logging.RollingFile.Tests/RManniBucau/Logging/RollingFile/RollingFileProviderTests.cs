...
public class RollingFileProviderTests
{
    ...
    public void Rotate()
    {
        ...
        Assert.Equal(["this too"], File.ReadAllLines(Path.Combine(ctx.Dir, "log-20240715-0.log")));
    }
    ...
    public void Delete()
    {
        ...
        Assert.Equal(
            ["this too"],
            File.ReadAllLines(Path.Combine(ctx.Dir, "log-20240722-0.log"))
        );
    }
